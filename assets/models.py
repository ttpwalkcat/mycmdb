...
class NIC(models.Model):
    """  网卡组件  """
    asset = models.ForeignKey("Asset", on_delete=models.CASCADE)
    name = models.CharField(max_length=128, blank=True, null=True, verbose_name="网卡名称")
...
class IDC(models.Model):
    ...
    mome = models.CharField(max_length=128, blank=True, null=True, verbose_name="备注")
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey(User, blank=True, null=True, on_delete=models.SET_NULL, verbose_name="事件执行人")
    memo = models.TextField(blank=True, null=True, verbose_name="备注")
