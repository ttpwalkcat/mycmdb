...
def get_os_info():
    ...
    :return:
    """
    distributor = subprocess.Popen("sudo lsb_release -a|grep 'Distributor ID'", stdout=subprocess.PIPE, shell=True)
...
def get_ram_info():
    ...
    ram_list = []
    # print("raw_ram_list1 is %s" % raw_ram_list)
...
def get_nic_info():
    ...
    # print("raw_data1 is %s" % raw_data)
    raw_data = raw_data.stdout.read().decode().split("\n")
    # print("raw_data2 is %s" % raw_data)
...
def get_disk_info():
    ...
    try:
        ...
        # print("raw_data3 is %s" % raw_data)
        data_list = raw_data.split(",")
        # print("data_list is %s" % data_list)
